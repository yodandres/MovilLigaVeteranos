namespace FlagMovilPortable.Services
{
    ...
    public class ApiService
    {
        ...
        /* Metodo para traer las estadisticas en Tournaments, se le agrego el id */
        ...
        public async Task<Response> PasswordRecovery(string urlBase, string servicePrefix, string controller, string email)
        {
            try
            {
                var userRequest = new UserRequest { Email = email, };
